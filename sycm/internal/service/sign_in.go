...
import (
	...
	"github.com/realwrtoff/rest_grpc/sycm/internal/model"
)
...
func (s *SycmService) SignIn(ctx context.Context, req *sycmApi.SignInReq) (*sycmApi.SignInRes, error) {
	requestID := rpcx.MetaDataGetRequestID(ctx)

	signInRes := &sycmApi.SignInRes{
		Status: 200,
		Message: "success",
		Token: "",
	}
